  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light backg">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">ثبت دریافتی</a>
        ...
        <form id="entry" method="get">
          <div class="form-group">
            ...
            <select class="form-control" id="monthSelect" name="mounth">
              ...
              <option value="dfar">فروردین</option>
              <option value="dord">اردیبهشت</option>
              <option value="dkho">خرداد</option>
              <option value="dtir">تیر</option>
              <option value="dmor">مرداد</option>
              <option value="dsha">شهریور</option>
              <option value="dmehr">مهر</option>
              <option value="daban">آبان</option>
              <option value="dazar">آذر</option>
              <option value="dday">دی</option>
